...
func AnalyticsPreferences() string { return filepath.Join(InstallDir, "analytics.json") }
func AnalyticsState() string       { return filepath.Join(Cache(), "analytics-state.json") }
